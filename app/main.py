...
from .core.config import CORS_ORIGINS, EMBEDDING_MODEL, INDEX_DIR, LLM_PROVIDER
from .observability.phoenix import configure_tracing
...
async def lifespan(app: FastAPI):
    ...
    chain, retriever = make_chain(
        INDEX_DIR, EMBEDDING_MODEL, LLM_PROVIDER
    )  # This connects to the knowledge database and sets up the AI
